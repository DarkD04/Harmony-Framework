/// @description Add background
	...
	add_background_line(spr_bg_teststage_water, 0, 0.94, v_scroll, 0, 0, 0, 128, 2, 0.003);
	...
	add_background(spr_bg_teststage_ruins, 0, 2/3, 2/3, 0, 0, 0, 354, false);
	add_background(spr_bg_teststage_ruins, 1, 2/3, 2/3, 0, 0, 0, 898, false);
	// HCZ-like 3d water parallax
	add_background_line(spr_bg_teststage_water, 1, 2/3, 2/3, 0, 0, 0, 898, 1, (2/3)/96);
